...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <img src="../../img/add.png" id="ImageButtonCriarPrateleira" title="Criar Prateleira"
                    align="Top" width="16" height="16" style="cursor: pointer" />
            </td>
        </tr>
    </table>
    <br />
    ...
    <img src="../../img/main-menu.png" id="ImageButtonAssociacao" align="Top" width="24"
        height="24" style="cursor: pointer" title="Associar Livro a Autor" />
